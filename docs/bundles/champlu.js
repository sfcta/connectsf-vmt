...
var DATA_VIEW = 'lua2017_v3';

var FRAC_COLS = ['speed', 'time', 'vol', 'vmt', 'vhd', 'vht', 'pti80', 'pti80_vmt'];
var YR_LIST = [2015, 2020, 2025, 2030, 2035, 2040];
...
var app = new Vue({
  ...
  data: {
    ...
    selected_metric: 'hh',
    metric_options: [{ text: 'Households', value: 'hh' }, { text: 'CIE_EMP', value: 'cie' }, { text: 'MED_EMP', value: 'med' }, { text: 'MIPS_EMP', value: 'mips' }, { text: 'PDR_EMP', value: 'pdr' }, { text: 'RET_EMP', value: 'ret' }, { text: 'VIS_EMP', value: 'vis' }, { text: 'TOT_EMP', value: 'tot' }],
    chartTitle: 'HH TREND',
